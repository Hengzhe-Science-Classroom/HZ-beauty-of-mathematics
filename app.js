// === The Beauty of Mathematics · Interactive - Core Application ===
...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('beauty-of-mathematics-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('beauty-of-mathematics-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
